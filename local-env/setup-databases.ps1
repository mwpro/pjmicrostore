...
dotnet ef database update -p ..\src\Products\Products.Catalog\ --context ProductsContext
dotnet ef database update -p ..\src\Products\Products.Catalog\ --context PhotosContext
